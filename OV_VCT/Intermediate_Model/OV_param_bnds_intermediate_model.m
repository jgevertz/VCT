...
% the intermediate model. It does so manually, by considering any       %
% biological constraints and trying to get the trajectories to cover    %
% a range at least as wide as the region allowable for a VP.            %
%                                                                       %
% Updated: 6/4/2025                                                     %
%                                                                       %        
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p_fixed = [1 tumor_mean(1) 0 10]; % dI, U0, I0, V0
...
%     r,    beta*1000,  delta_V,  alpha/1000
lb = [0.28, 0.4,        0.1,      1];
ub = [0.37, 4,          5,        5]; 
Nparams = length(lb);
...
sgtitle('Intermediate Model','FontSize',16,'FontWeight','bold')
for i = 1:Nparams
...
saveas(gcf,'param_bounds_intermediate.fig');
exportgraphics(gcf,'param_bounds_intermediate.png');

save param_bounds_intermediate.mat lb ub mean_params std_params p_fixed
