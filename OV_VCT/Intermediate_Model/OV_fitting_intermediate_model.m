%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%                                                                       %
% This codes finds the best fit parameters in the intermediate OV model %
...
%                                                                       %   
% Output using numSobols = 625: Best fit has cost of = 0.265393 with    %
%   r = 0.280017                                                        %
%   beta = 0.002212                                                     %
%   delta_V = 4.938787                                                  %
%   alpha = 1896.086095                                                 %
% Elapsed time is 180.606283 seconds.                                   %
%                                                                       %
% Updated: 6/4/2025                                                     %
%                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Parameters to fit in order: r, beta, delta_V, alpha
...
for i = 1:5
    ...
    sgtitle(['r = ' num2str(param(index(i),1)) ', \beta = ' ...
        ...
        num2str(param(index(i),4)*1000)],'FontSize',16,...
        'FontWeight','bold'); 
    subplot(2,2,1)
...
save best_fit_intermediate.mat best_fit_params best_fit_objective p_fixed ...
...
function cost = objective(p_fit,p_fixed,tumor_mean,tumor_STD,tf) 
    ...
    %cost = sum((tumor_mean-modeldata).^2); % SSE
    cost = 0.5*sum(((tumor_mean-modeldata).^2)./(tumor_STD.^2)); %sum(SE/var)
    %cost = 0.5*sum( tumor_mean*.((tumor_mean-modeldata).^2)./(tumor_STD.^2) ); 
    %PNAS cost function is different
end
