...
%  - NVPops = 500 required generating 6138 plausible patients if we     %
%    truncate the parameters after generating the prior.                %
%    Run time = 31.353615 seconds.                                      %
%  - NVPops = 500 required generating 6363 plausible patients if we     %
%    truncate the parameters after generating the prior.                %
%    Run time = 30.613278 seconds.                                      %
...
% corresponding fit file. Run time = 2212.809107 seconds.               %
%                                                                       %
