...
%                                                                       %
% Elapsed time is 76.122996 seconds (for dose_scaling = 1:1:40)         %
% Updated: 6/6/2025                                                     %
%                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
load best_fit_complex.mat % Contains lb, ub, 
                          % p_fixed = [delta_I, delta_T U0, I0, V0, T0]
load Vpops_acc_rej.mat  % Contains VP params in order
                        % [r, beta, delta_V, alpha, gamma_I, epsilon, lambda]
undetectable_threshold = 1; % small
T0 = p_fixed(3);
V0 = p_fixed(5); % experimental dose     
NVPops = size(Vpop,1);
dose_scaling = 1:1:40; 
...
for j = 1:length(dose_scaling)
    p_fixed(5) = V0*dose_scaling(j); % scale dose
