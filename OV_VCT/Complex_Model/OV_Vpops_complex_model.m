...
%  - NVPops = 500 required generating 6247 plausible patients if we     %
%    truncate the parameters after generating the prior.                %
%    Run time = 26.899769 seconds.                                      %
%  - NVPops = 500 required generating 6422 plausible patients if we     %
%    truncate the parameters after generating the prior.                %
%    Run time = 26.259733 seconds.                                      %
